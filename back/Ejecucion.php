<?php
    ...
    if(empty($a)){
        ...
        $resultado = '<div class="divPadreQuery col-lg-12 p-2 text-center row">';
        foreach ($a as $key) {
            $resultado .= '<div class="divQuery col-lg-5 mt-5 ml-auto mr-auto p-4 text-center roundedBorder">';
